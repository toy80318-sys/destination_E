...
const PHASE2_CUTSCENES_KO={
  ...
  p2_ch03b:[
    ...
    {char:'delivery_F01', name:'코르비누스', color:'#d4a574', text:'(다가오며) 거기 누구야? 이 구역 진입은 거래자만 가능해.'}
  ],

  // ─── CH03-C "가가린의 항법 데이터" (Q07-M 완료) ───
  p2_ch03c:[
    {char:'hero04', name:'가가린', color:'#ffd700', text:'이 항로 — 60년대에 소련 우주국이 비밀 분류한 경로야. 지금은 크리그가 쓰고 있어.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'메카니카 부품이 오미크론 퍼세이 교역소에서 크리그로 넘어가. 에이전트 코드명 \'오르크\'.'},
  ...
  // ─── CH04-B "표면 아래" (P07 도착) ───
  p2_ch04b:[
    {char:'hero04', name:'가가린', color:'#ffd700', text:'저 컨베이어 동선 이상해. 크리스탈 일부가 지하로 내려가고 있어. 광산 창고 치고 루트가 너무 깊어.'},
    {char:'hero08', name:'마르코 폴로', color:'#ffd700', text:'노동자들이 겁먹어 있어. 크리그한테 협박당하고 있는 거야.'},
    {char:'commander', name:'{사령관}', color:'#00f3ff', text:'(노동자 한 명과 눈을 마주친다. 그가 작게 고개를 끄덕인다)'}
  ],

  // ─── CH04-C "이순신의 이름" (Q09-03 테슬라 구출 후) ───
  p2_ch04c:[
    {char:'hero07', name:'테슬라', color:'#ffd700', text:'크리그가 이순신 장군 캡슐을 왜 봉인했는지 알아? 그분의 전술 학습 데이터가 크리그 방어 알고리즘에 통합돼 있어. 살아있는 방패인 거야.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'그분을 꺼내면... 크리그 방어 알고리즘의 약점을 우리가 갖는 건가?'},
  ...
  p2_ch04d:[
    ...
    {char:'hero04', name:'가가린', color:'#ffd700', text:'지하 감옥 진입 루트가 있어. 자연 균열대 — 셔틀 한 대가 들어갈 수 있는 폭이야.'},
    {char:'commander', name:'{사령관}', color:'#00f3ff', text:'이순신 장군이 수백 년째 저기 갇혀 있어. 우리가 끝내야 해.'},
    {char:'baekgu2_advice', name:'백구', color:'#66ddff', text:'균열대 진입 좌표 입력. 정숙 기동 모드 전환.'}
  ],
