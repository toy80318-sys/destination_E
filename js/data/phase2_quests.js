...
const PHASE2_CUTSCENES_KO={
  ...
  p2_ch04c:[
    {char:'hero07', name:'테슬라', color:'#66ffff', text:'크리그가 이순신 장군 캡슐을 왜 봉인했는지 알아? 이순신 장군은 수백 년 전 — 크리그가 지구 항로를 처음 봉쇄할 때 — 저항했던 유일한 존재야. 그 전술 데이터를 크리그가 강제 추출해 방어 알고리즘에 통합했어. 살아있는 방패인 거야. 이순신 장군이 살아서 움직이면 크리그 알고리즘이 스스로 무너질 수도 있어.'},
