...
const PARTS=[
  ...
  // ── 미사일 무기 (10종) ────────────────────────────────────
  {id:'ML01',cat:'weapon',nm:'타우 미사일',tier:2,wtype:'missile',ATT:20,price:3000,faction:'F06',desc:'[F06 지구저항군] 이강호 박사 개발. 게릴라전용 경량 열추적 미사일. 실드 약세 / 장갑 관통 특화.'},
  {id:'ML02',cat:'weapon',nm:'크리그 충격탄',tier:4,wtype:'missile',ATT:45,price:14000,faction:'F04',desc:'[F04 크리그] 화산 마그마 코어 폭발 에너지 탄두. 기원지대 전쟁영주 카를로스 승인. 장갑 파괴 전문.'},
  ...
  {id:'ML04',cat:'weapon',nm:'수퍼비아 중력 미사일',tier:8,wtype:'missile',ATT:110,price:45000,faction:'F01',desc:'[F01 수퍼비아] 소피아 모렐 설계. 중력 집속 탄두. 명중 시 적 ENG -20% (1턴 지속).'},
  ...
  {id:'MMB01',cat:'weapon',nm:'이휘소 방정식 미사일 ❖신화',tier:20,wtype:'missile',ATT:380,price:0,rarity:'mythic',quest:true,faction:'F06',desc:'[신화급] 고 이휘소 박사의 입자물리 방정식 구현. DEF/SHD 관통 + 크리티칼 +30%. 빛의 속도를 넘어 다각도 공격 다중 충격파 생성.'},
  ...
  {id:'SARM01',cat:'armor',nm:'광개토 선체 ◈세트',tier:17,HP:6000,DEF:100,price:0,rarity:'set',setId:'goguryeo',quest:true,faction:'F06',desc:'[광개토 세트(2종)] 보유 시 ATT+100, DEF+40. 고구려 철갑 공법 응용. 피격 시 자동 회피 +15%.'},
