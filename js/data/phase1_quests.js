...
const PHASE1_QUESTS={
  ...
  P01:[
    ...
    // ── Q01-M 백구의 기억 (히든) ──
    {
      ...
      desc:{ko:'격납고 깊숙한 구석, 먼지 쌓인 화물 상자. 백구가 100년 전부터 보관하고 있었다. 안에는 {사령관}의 유품 — 수퍼비아 귀족 향수 한 병.',
            en:'A dusty crate deep in the hangar. Baekgu kept it for 100 years. Inside: {사령관}\'s memento — a Superbia Noble Perfume.'},
      objectives:[
  ...
  P03:[
    ...
    // ── Q02-04 소형 추진 파츠 업그레이드 (서브 함선구매) ──
    {
      ...
      desc:{ko:'마르코: "에리다니까지 가려면 함선이 좀 더 빨라야 해. 바나드 프라임 도크에서 추진 파츠 달자."\n소형 추진 파츠 구매(20,000₡) → 파츠 슬롯 +1 장착 → 기동력 +10%.',
  ...
  P05:[
    // ── Q03-01 아우레우스 입항 허가 (메인) ──
    {
      ...
      desc:{ko:'세관: "수퍼비아 출신이면 중력수정 세관 신고 필수. 미신고 시 전량 몰수."\nG05 ×2 자진 신고 → 아우레우스 시세(개당 2,520₡)로 자진 판매 → 입항 허가.',
            en:'Customs: "Declare Gravity Crystal or lose all." Declare Superbia Gravity Crystal ×2 → auto-sell at 2,520₡ each.'},
      objectives:[
    ...
    // ── Q03-04 함선 강화 — 아우레우스 방어 파츠 (서브) ──
    {
      ...
      desc:{ko:'마르코: "티가든 금융 b 파츠샵에 좋은 게 있어. LHS 크리스탈이 있으면 보조 결제 돼서 싸게 살 수 있어."\nG06 ×1 + 15,000₡ → 아우레우스 방어 파츠 장착 → 방어력 +15%.',
  ...
  P06:[
    // ── Q04-01 LHS 광산 착지 허가 (메인) ──
    {
      ...
      objectives:[
        {type:'gather', item:'G04', qty:1, label:{ko:'아우레우스 금괴 ×1 납부', en:'Pay Aureus Gold Ingot Aureus Gold ×1'}},
      ],
      rewardCr:2000, rewardVe:25,
