...
const SYSTEM_GUIDE=[
  ...
  {key:'clog',   icon:'📋', name:I18N.t('sys.clog.name'),   img:'img/hub/clog.png',   location:I18N.t('sys.clog.location'),   desc:I18N.t('sys.clog.desc'),   operator:I18N.t('sys.clog.operator'),   unlock:I18N.t('sys.clog.unlock'),   features:I18N.t('sys.clog.features'),   warn:I18N.t('sys.clog.warn'),   quip:I18N.t('sys.clog.quip')},
  ...
  {key:'planets',icon:'🌐', name:I18N.t('sys.planets.name'),img:'img/hub/front.png',  location:I18N.t('sys.planets.location'),desc:I18N.t('sys.planets.desc'),operator:I18N.t('sys.planets.operator'),unlock:I18N.t('sys.planets.unlock'),features:I18N.t('sys.planets.features'),warn:I18N.t('sys.planets.warn'),quip:I18N.t('sys.planets.quip')}
];
