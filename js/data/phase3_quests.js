...
const PHASE3_QUESTS={
  ...
  P22:[
    // ── Q11-01 저항군 기지 착지 허가 (메인 자동) ──
    {
      ...
      desc:{ko:'착지 코드 대신 강습 스파이크 강습 스파이크 ×1 제공(크리그 획득 물자 — 저항군 정보가치 입증) → 지하 방공호 에코 기지 착지 허가.\n레인저: "이순신 장군... 살아계셨군요."',
            en:'Submit 강습 스파이크 ×1 (Krieg materiel) instead of code → Echo Base landing approved. Ranger: "Admiral... you live."'},
      objectives:[
        {type:'gather', item:'G12', qty:1, label:{ko:'강습 스파이크 강습 스파이크 ×1 제출', en:'Submit 강습 스파이크 ×1'}},
      ],
    ...
    // ── Q11-03 에코 주점 정보 수집 (선택 주점) ──
    {
      ...
      desc:{ko:'에코 기지 비공개 주점. 전통 발효주 전통 발효주 ×2 소비 → 정보원 "케이드": "P23 오딧세이 보급망에서 이상한 화물 움직임이 있어. 크리그 색깔이야."\n주점 가챠 가능 (정예 2,000₡ 또는 VC 5).',
            en:'전통 발효주 ×2 → Kade: "Strange Krieg-pattern cargo in P23 supply." Tavern gacha available.'},
      objectives:[
        {type:'gather', item:'G14', qty:2, label:{ko:'전통 발효주 전통 발효주 ×2', en:'전통 발효주 ×2'}},
      ],
    ...
    // ── Q11-M 저항군 1차 연대 합의 (이벤트 스토리) ──
    {
      ...
      desc:{ko:'지구 철광석 지구 철광석 ×2 소비(저항군 전통 연대 의식) → 1차 연대 협약 체결.\n레인저: "R06 반물질 5단 팩을 드릴게요. 더 필요하면 P26 본부에 오세요."',
            en:'지구 철광석 ×2 → 1st pact. Ranger: "R06 ×5 pack. More at P26 HQ."'},
      objectives:[
        {type:'gather', item:'G15', qty:2, label:{ko:'지구 철광석 지구 철광석 ×2 의식', en:'지구 철광석 ×2 pact ritual'}},
      ],
  ...
  P23:[
    ...
    // ── Q12-02 크리그 첩자 추적 (메인) ──
    {
      ...
      desc:{ko:'기지 민간인에게 지구 빈티지 씨앗 지구 빈티지 씨앗 ×2 소비(정보 대가) → 첩자 실체 파악: 보급 담당 \'오그렌\'이 크리그 이중 스파이.\n추가: "오그렌이 아우레우스 기업 코르넬리우스와도 연결돼 있어."',
    ...
    // ── Q12-04 오딧세이 외곽 잔해 탐색 (서브 + LGD02 5% 드롭) ──
    {
      ...
      desc:{ko:'오그렌 격퇴 후 외곽 잔해 구역 정리. 잔해 탐색 3회.\n탐색 중 워덴클리프 워덴클리프 설계도 조각 5% 드롭 (화성 저항군 드롭 행성).',
  ...
  P11:[
    ...
    // ── Q14-M 장영실 합류 (영웅 퀘스트) ──
    {
      ...
      objectives:[
        {type:'gather', item:'G10', qty:3, label:{ko:'크리그 무기 원석 크리그 무기 원석 ×3', en:'크리그 무기 원석 Krieg ore ×3'}},
  ...
  P26:[
    ...
    // ── Q15-05 P26 아카이브 탐색 — 설계도 드롭 (서브) ──
    {
      ...
      desc:{ko:'저항군 기술 아카이브 전면 탐색. 타이탄 기지은 거북선 거북선 / H10 레비아탄 / H12 우르사 파쇄기 설계도 드롭 행성.\n탐색 중 각 5% 확률로 설계도 조각 획득.',
...
const PHASE3_CUTSCENES_KO={
  ...
  // ─── CH05-A "첫 연락" (P22 도착) ───
  p3_ch05a:[
    {char:'hero01', name:'이순신', color:'#c0a060', text:'동쪽 항로 주파수... 지하 방공호. 저항군 암호 채널이야. 내가 봉인되기 전에 함께했던 전우들의 후예가 그 기지를 운영하고 있어.'},
    ...
    {char:'system', name:'저항군 통신', color:'#88d65b', text:'지하 방공호 에코 기지 — 도착 확인. 착지 코드를 제시하라.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'...크리그에서 빼낸 물자를 가져가면 믿어줄 거야.'},
    {char:'commander', name:'{사령관}', color:'#00f3ff', text:'강습 스파이크 강습 스파이크 있어. 그걸로 충분하다.'}
  ],
  ...
  p3_ch05b:[
    ...
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'크리그가 화성 저항군 보급망에 첩자를 심었어요. 우리 내부를 흔들고 있는 거예요.'},
    {char:'hero08', name:'마르코 폴로', color:'#ffd700', text:'화성 저항군... 오딧세이 기지. 나도 루트 알아.'},
  ...
  p3_ch06a:[
    ...
    {char:'hero04', name:'가가린', color:'#ffd700', text:'글리제 667Cc 글리제 667Cc. 코르넬리우스 본사가 거기야.'},
    ...
    {char:'baekgu2_advice', name:'백구', color:'#66ddff', text:'글리제 667Cc 항로 입력. 아우레우스 영공 진입 절차 검토 중.'}
  ],
  ...
  p3_ch06b:[
    ...
    {char:'hero03', name:'광개토대왕', color:'#ff9d52', text:'이 행성을 내 손에 넣으면 — 당신과 거래하겠소. 단, 글리제 667Cc 경매에서 최고가를 내야 하오.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'저 사람... 경매 자본이 필요하다. 우리가 글리제 667Cc을 낙찰받으면 그가 온다.'},
    {char:'baekgu2_advice', name:'백구', color:'#66ddff', text:'광개토대왕(H03) 합류 조건 등록. 글리제 667Cc 경매 낙찰가 약 4,100만 크레딧.'}
  ],
  ...
  p3_ch06c:[
    ...
    {char:'hero01', name:'이순신', color:'#c0a060', text:'케플러-62f 메카니카 기어월드. 그곳에 장영실이라는 기술자가 있어. 조선 시대 장영실의 기술 DNA를 이어받은 복제 기술자야.'},
  ...
  p3_ch06d:[
    ...
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'(크리그 무기 원석 크리그 무기 원석을 들어 살핀다) 크리그 무기 원석... 이걸로 용골을 만들면 되겠군. 근데 재료가...'},
  ...
  // ─── CH07-A "귀환" (Q14-M 완료) ───
  p3_ch07a:[
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'거북선 완성에 저항군 반물질 저항군 반물질이 25개 필요해. 지금 우리한테 있는 건...'},
    {char:'hero08', name:'마르코 폴로', color:'#ffd700', text:'최대해봐야 8~10개.'},
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'저항군 본부 타이탄 기지에 비축이 있을 거야. 레인저한테 받아야 해.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'타이탄 기지... 그리고 지구. 지구.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'지구. (잠시 침묵) 오래 꿈꿨어.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'{사령관}. 방향은 타이탄 기지이야. 연대를 공식화하고 저항군 반물질를 확보하자.'}
  ],

  // ─── CH07-B "본부" (P26 도착) ───
  p3_ch07b:[
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'당신들이 직접 왔군요. 코르넬리우스 사건 — 우리도 들었어요. 아이젠클로가 직접 기술을 구입했다면 생각보다 위협이 심각해요.'},
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'그래서 왔어요. 거북선을 만들 거야. 저항군 반물질 반물질 25개와 저항군 제작 베이 지원이 필요해요.'},
  ...
  p3_ch07c:[
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'저항군 반물질 재료 목록 완성됐어. 거북선 제작 시작 가능해.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'저항군 반물질 ×25, 은하 혼돈 결정 ×15, 수퍼비아 중력자 ×10, 크리그 마그마 코어 ×8. 모두 확보하면 거북선이 완성된다.'},
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'크리그가 Kepler-442b 행성에 새 거점을 짓고 있어요. 아이젠클로가 직접 지휘 중이에요.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'글리제 667Cc 데이터 복호기가 해독한 정보와 일치해. Kepler-442b가 다음 목표야.'},
    ...
    {char:'hero01', name:'이순신', color:'#c0a060', text:'{사령관}. 페이즈 4 — 행성 16~20. Kepler-442b 아이젠클로 추적. 거북선 완성.'},
