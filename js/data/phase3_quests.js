...
const PHASE3_QUESTS={
  ...
  P22:[
    ...
    // ── Q11-03 에코 주점 정보 수집 (선택 주점) ──
    {
      ...
      desc:{ko:'에코 기지 비공개 주점. 전통 발효주 ×2 소비 → 정보원 "케이드": "화성 저항군 오딧세이 보급망에서 이상한 화물 움직임이 있어. 크리그 색깔이야."\n주점 가챠 가능 (정예 2,000₡ 또는 VC 5).',
            en:'Traditional Fermented Liquor ×2 → Kade: "Strange Krieg-pattern cargo in Mars Resistance supply." Tavern gacha available.'},
      objectives:[
    ...
    // ── Q11-M 저항군 1차 연대 합의 (이벤트 스토리) ──
    {
      ...
      desc:{ko:'지구 철광석 ×2 소비(저항군 전통 연대 의식) → 1차 연대 협약 체결.\n레인저: " 반물질 5단 팩을 드릴게요. 더 필요하면 타이탄 기지 본부에 오세요."',
            en:'Earth Iron Ore ×2 → 1st pact. Ranger: "Resistance Antimatter ×5 pack. More at Titan Base HQ."'},
      objectives:[
  ...
  P08:[
    ...
    // ── Q13-05 아이템 제작 — 데이터 복호기 (서브) ──
    {
      ...
      desc:{ko:'에바: " 정보 칩과 태양핵을 결합하면 복호기를 만들 수 있어요."\nG24 ×1 + 아우레우스 태양핵 ×2 → 데이터 복호기 → 로그 완전 해독.\n해독 로그: "아이젠클로의 다음 행선지 — Kepler-442b 크리그 공장 행성."',
            en:'Aureus Information Chip ×1 + Aureus Solar Core ×2 → decoder → "Eisenklaue\'s next stop — Kepler-442b Krieg factory planet."'},
      objectives:[
    ...
    // ── Q13-H 광개토대왕 첫 만남 (히든 영웅 사전) ──
    {
      ...
      desc:{ko:'글리제 667Cc 항구 — 고구려 기치를 단 대형 상선. 광개토 등장.\n광개토: "이 행성을 내 손에 넣으면 — 당신과 거래하겠소. 단, 글리제 667Cc 경매에서 최고가를 내야 하오."\n→ 합류 조건 등록 (Phase 4 글리제 667Cc 경매 낙찰 ~4,100만₡).',
            en:'Gwanggaeto appears at Gliese 667Cc port. Condition: win Gliese 667Cc auction (~41M₡) in Phase 4.'},
      objectives:[
  ...
  P11:[
    ...
    // ── Q14-03 크리그 정찰대 격퇴 (메인 전투) ──
    {
      ...
      desc:{ko:'가가린: "크리그 정찰함 2기가 기어월드에 접근 중이야. 글리제 667Cc 코르넬리우스 사건 때문에 추적해온 것 같아."\n정찰대 격퇴. 장영실: "...고마워. 내 작업실까지 들이닥칠 뻔했어."',
    ...
    // ── Q14-M 장영실 합류 (영웅 퀘스트) ──
    {
      ...
      objectives:[
        {type:'gather', item:'G10', qty:3, label:{ko:'크리그 무기 원석 ×3', en:'Krieg Weapon Ore Krieg ore ×3'}},
  ...
  P26:[
    ...
    // ── Q15-04 저항군 대형 함선 구매 (서브 함선구매) ──
    {
      ...
      desc:{ko:'마르코: "타이탄 기지 도크에서 저항군 대형 함선 살 수 있어. HP가 모든 클래스 중 최강이야."\nF06 저항군 대형 함선(1,020,000₡) 구매 → 페이즈 4 크리그 요새 공략 대비.',
    ...
    // ── Q15-05 P26 아카이브 탐색 — 설계도 드롭 (서브) ──
    {
      ...
      desc:{ko:'저항군 기술 아카이브 전면 탐색. 타이탄 기지은 거북선 / 레비아탄 / 우르사 파쇄기 설계도 드롭 행성.\n탐색 중 각 5% 확률로 설계도 조각 획득.',
            en:'Search Titan Base archive. 5% each for Geobukseon / Leviathan / Ursa Crusher fragments.'},
      objectives:[
...
const PHASE3_CUTSCENES_KO={
  ...
  p3_ch05b:[
    {char:'maximov', name:'레인저 맥시모프', color:'#9ee7ff', text:'우리 저항군은 지구에서 쫓겨난 사람들이에요. 치크스와 우르사 메이저가 지구를 봉쇄하고, 그 하수인 크리그가 외곽 항로를 틀어막기 전, 이순신 장군과 함께 맞서 싸웠던 선조들의 후손들이죠. 400년 전 이 방공호를 파고, 여기서 태어났어요.'},  // 수정 2026-06-13: 크리그=치크스 하수인 군벌로 격하 — GDD: 치크스/우르사 메이저가 메인
  ...
  p3_ch07a:[
    ...
    // ─── CH07-B "본부" (P26 도착) ───
  p3_ch07b:[
    {char:'maximov', name:'레인저 맥시모프', color:'#9ee7ff', text:'당신들이 직접 왔군요. 코르넬리우스 사건 — 우리도 들었어요. 아이젠클로가 직접 기술을 구입했다면 생각보다 위협이 심각해요.'},
...
console.log('[PHASE3_QUESTS v1.0] Loaded — 30 quests across 5 planets (P22·P23·P08·P11·P26), 10 