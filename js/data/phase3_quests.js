...
const PHASE3_CUTSCENES_KO={
  ...
  p3_ch05b:[
    {char:'gather_F06', name:'레인저 맥시모프', color:'#9ee7ff', text:'우리 저항군은 지구에서 쫓겨난 사람들이에요. 크리그가 지구 항로를 봉쇄하기 전, 이순신 장군과 함께 싸웠던 선조들의 후손들이죠. 400년 전 이 방공호를 파고, 여기서 태어났어요.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'당신들이 살아있었군." *(조용히)* "오래 기다렸겠군.'},
    {char:'system', name:'레인저', color:'#9ee7ff', text:'살아남은 것만으로 부족했어요. 지금 크리그가 보급망에 첩자를 심어두고 우리 내부를 흔들고 있어요. 믿을 수 있는 동료가 절실해요.'},
    ...
    {char:'system', name:'레인저', color:'#9ee7ff', text:'연대의 증표를 먼저. 지구 철광석 — 지구의 땅에서 온 것으로 서약하는 게 우리 전통이에요.'}
  ],
  ...
  p3_ch06b:[
    ...
    {char:'system', name:'광개토', color:'#9ee7ff', text:'당신이 {사령관}인가. 크리그와 싸우고 있다고 들었소.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'...광개토. 이름이 낯설지 않군." *(낮게)* "당신의 상선이 경매 시장 기록을 갖고 있다는 건 알고 있었소.'},
    {char:'system', name:'광개토', color:'#9ee7ff', text:'소문은 정확하군. 나는 이 은하계 어느 팩션에도 속하지 않아. 자유 상인이야. 하지만 크리그와 같이 거래하지는 않소.'},
    {char:'system', name:'광개토', color:'#9ee7ff', text:'이 행성을 내 손에 넣으면 — 당신과 거래하겠소. 단, 경매에서 최고가를 써내야 하오. 내가 합류할 만한 상대인지 보는 거요.'}
  ],
  ...
  p3_ch07b:[
    ...
    {char:'system', name:'레인저', color:'#9ee7ff', text:'...공식 연대 협약을 먼저 체결해야 합니다. 지구의 방식으로.'}
  ],
  ...
  p3_ch07c:[
    ...
    {char:'system', name:'레인저', color:'#9ee7ff', text:'크리그가 행성에 새 거점을 짓고 있어요. 아이젠클로가 직접 지휘 중이에요.'},
