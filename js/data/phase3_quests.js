...
const PHASE3_QUESTS={
  ...
  P22:[
    // ── Q11-01 저항군 기지 착지 허가 (메인 자동) ──
    {
      ...
      desc:{ko:'착지 코드 대신 G12 강습 스파이크 ×1 제공(크리그 획득 물자 — 저항군 정보가치 입증) → P22 에코 기지 착지 허가.\n레인저: "이순신 장군... 살아계셨군요."',
            en:'Submit G12 ×1 (Krieg materiel) instead of code → Echo Base landing approved. Ranger: "Admiral... you live."'},
      objectives:[
        {type:'gather', item:'G12', qty:1, label:{ko:'G12 강습 스파이크 ×1 제출', en:'Submit G12 ×1'}},
      ],
    ...
    // ── Q11-02 G18 재보충 (메인) ──
    {
      ...
      objectives:[
        {type:'gather', item:'G13', qty:2, label:{ko:'G13 ×2 열람 비용', en:'G13 ×2 archive fee'}},
      ],
    ...
    // ── Q11-03 에코 주점 정보 수집 (선택 주점) ──
    {
      ...
      desc:{ko:'에코 기지 비공개 주점. G14 전통 발효주 ×2 소비 → 정보원 "케이드": "P23 오딧세이 보급망에서 이상한 화물 움직임이 있어. 크리그 색깔이야."\n주점 가챠 가능 (정예 2,000₡ 또는 VC 5).',
            en:'G14 ×2 → Kade: "Strange Krieg-pattern cargo in P23 supply." Tavern gacha available.'},
      objectives:[
        {type:'gather', item:'G14', qty:2, label:{ko:'G14 전통 발효주 ×2', en:'G14 ×2'}},
      ],
    ...
    // ── Q11-05 P22 에코 행성 경매 (서브 경매) ──
    {
      ...
      nm:{ko:'P22 에코 행성 경매', en:'P22 Echo Auction'},
      desc:{ko:'에코 기지 경매소에서 P22 행성 소유권 경매. 즉시구매 ~71,760₡ / 최저입찰 ~21,528₡.\n낙찰 시 P22 매 턴 세금 5,000₡ 수입 + 저항군 함선 상시 구매 가능.',
            en:'Bid on P22 ownership. Buyout ~71,760₡, min bid ~21,528₡. Owning → 5,000₡/turn tax + resistance ship access.'},
      objectives:[
        {type:'explore', target:'p22_auction', qty:1, label:{ko:'P22 경매 참여', en:'Participate auction'}},
      ],
    ...
    // ── Q11-M 저항군 1차 연대 합의 (이벤트 스토리) ──
    {
      ...
      desc:{ko:'G15 지구 철광석 ×2 소비(저항군 전통 연대 의식) → 1차 연대 협약 체결.\n레인저: "R06 반물질 5단 팩을 드릴게요. 더 필요하면 P26 본부에 오세요."',
            en:'G15 ×2 → 1st pact. Ranger: "R06 ×5 pack. More at P26 HQ."'},
      objectives:[
        {type:'gather', item:'G15', qty:2, label:{ko:'G15 지구 철광석 ×2 의식', en:'G15 ×2 pact ritual'}},
      ],
  ...
  P23:[
    // ── Q12-01 오딧세이 잠입 (메인) ──
    {
      ...
      desc:{ko:'마르코가 화물 위장 플랜 제안: G13 ×2 소비(화물 목록 위조 증빙) → 합법적 화물로 위장해 내부 진입.\n창고 담당 \'키이로\': "화물 이상은 세 번째 구역부터야."',
            en:'Marco: cargo cover plan. G13 ×2 → infiltration. Kiiro: "Anomaly in zone 3."'},
      objectives:[
        {type:'gather', item:'G13', qty:2, label:{ko:'G13 ×2 위조 증빙', en:'G13 ×2 forged manifest'}},
      ],
    ...
    // ── Q12-02 크리그 첩자 추적 (메인) ──
    {
      ...
      desc:{ko:'기지 민간인에게 G28 지구 빈티지 씨앗 ×2 소비(정보 대가) → 첩자 실체 파악: 보급 담당 \'오그렌\'이 크리그 이중 스파이.\n추가: "오그렌이 아우레우스 기업 코르넬리우스와도 연결돼 있어."',
            en:'G28 ×2 → spy identified: Ogren, supply officer, linked to Aureus corp Cornelius.'},
      objectives:[
        {type:'gather', item:'G28', qty:2, label:{ko:'G28 ×2 정보 대가', en:'G28 ×2 informant fee'}},
      ],
    ...
    // ── Q12-04 오딧세이 외곽 잔해 탐색 (서브 + LGD02 5% 드롭) ──
    {
      ...
      desc:{ko:'오그렌 격퇴 후 외곽 잔해 구역 정리. 잔해 탐색 3회.\n탐색 중 LGD02 워덴클리프 설계도 조각 5% 드롭 (P23 드롭 행성).',
            en:'3× wreck search. 5% LGD02 Wardenclyffe blueprint chance.'},
      objectives:[
    ...
    // ── Q12-05 P23 행성 투자 (서브 투자) ──
    {
      ...
      ic:'📈', npc:'마르코 폴로', npcIc:'🗺️', npcKey:'hero08',
      nm:{ko:'P23 오딧세이 행성 투자', en:'P23 Investment'},
      desc:{ko:'오딧세이 기지 경제권 확보. P23 커머스 레벨 1 투자(~30,240₡) → 매 턴 세금 수입 +20% (5,000→6,000₡).',
            en:'Invest P23 commerce L1 (~30,240₡) → +20% tax/turn.'},
      objectives:[
        {type:'explore', target:'p23_commerce', qty:1, label:{ko:'P23 커머스 L1 투자', en:'Invest commerce L1'}},
      ],
  ...
  P08:[
    // ── Q13-01 닥터 에바 접선 (메인) ──
    {
      ...
      desc:{ko:'P08 글리제 항구 도착. 암호 통신으로 닥터 에바 접선.\nG04 아우레우스 금괴 ×2 소비(접선 비용) → 에바: "코르넬리우스 발테르 CEO가 아이젠클로에게 기술 자료를 넘기고 있어요. 창고 서버에 이전 로그가 있어요."',
            en:'G04 ×2 → meet Eva. "Walter sends data to Eisenklaue. Warehouse server has transfer logs."'},
      objectives:[
        {type:'gather', item:'G04', qty:2, label:{ko:'G04 ×2 접선 비용', en:'G04 ×2 contact fee'}},
      ],
      rewardCr:100000, rewardVe:70,
    ...
    // ── Q13-02 코르넬리우스 창고 잠입 (메인) ──
    {
      ...
      desc:{ko:'에바가 창고 접근 코드 제공. G23 ×2 소비(경비원 매수) → 잠입. G24 ×1 소비(접속 인증 생성) → 기술 이전 로그 다운로드.\n로그: "LGD 설계도 기반 생체 엔진 데이터를 P13 아이젠클로 직속 실험실로 3차례 전송."',
            en:'G23 ×2 (bribe) + G24 ×1 (auth) → download tech-transfer log to Eisenklaue lab.'},
      objectives:[
        {type:'gather', item:'G23', qty:2, label:{ko:'G23 ×2 경비원 매수', en:'G23 ×2 bribe'}},
        {type:'gather', item:'G24', qty:1, label:{ko:'G24 ×1 인증 생성', en:'G24 ×1 auth'}},
      ],
    ...
    // ── Q13-04 전투 후 수리 (서브) ──
    {
      ...
      nm:{ko:'P08 정비소 수리', en:'P08 Repair Shop'},
      desc:{ko:'코르넬리우스 보안팀과의 전투로 {함선} 손상. P08 정비소에서 수리.\n장영실(통신): "이번엔 내가 미리 봐줄게. 다음엔 내 작업실로 와."',
            en:'Repair {ship} at P08. Jang Yeong-sil (radio): "I\'ll prep it remotely. Next time, my workshop."'},
      objectives:[
    ...
    // ── Q13-05 아이템 제작 — 데이터 복호기 (서브) ──
    {
      ...
      desc:{ko:'에바: "G24 정보 칩과 R03 태양핵을 결합하면 복호기를 만들 수 있어요."\nG24 ×1 + R03 ×2 → 데이터 복호기 → 로그 완전 해독.\n해독 로그: "아이젠클로의 다음 행선지 — P14 크리그 공장 행성."',
            en:'G24 ×1 + R03 ×2 → decoder → "Eisenklaue\'s next stop — P14 Krieg factory planet."'},
      objectives:[
        {type:'gather', item:'G24', qty:1, label:{ko:'G24 ×1', en:'G24 ×1'}},
        {type:'gather', item:'R03', qty:2, label:{ko:'R03 ×2', en:'R03 ×2'}},
      ],
    ...
    // ── Q13-H 광개토대왕 첫 만남 (히든 영웅 사전) ──
    {
      ...
      desc:{ko:'P08 항구 — 고구려 기치를 단 대형 상선. 광개토(H03) 등장.\n광개토: "이 행성을 내 손에 넣으면 — 당신과 거래하겠소. 단, P08 경매에서 최고가를 내야 하오."\n→ H03 합류 조건 등록 (Phase 4 P08 경매 낙찰 ~4,100만₡).',
            en:'Gwanggaeto (H03) appears at P08 port. Condition: win P08 auction (~41M₡) in Phase 4.'},
      objectives:[
  ...
  P11:[
    // ── Q14-01 기어월드 착지 허가 (메인) ──
    {
      ...
      desc:{ko:'기어월드 자치 도크 위원회가 통행세 요구. G07 ×2 소비(메카니카 통행세 현물 납부) → 착지 허가.\n작업실 구역 이동 허가 — 장영실 위치 확인.',
            en:'G07 ×2 transit fee → landing approved. Workshop access granted.'},
      objectives:[
        {type:'gather', item:'G07', qty:2, label:{ko:'G07 ×2 통행세', en:'G07 ×2 transit'}},
      ],
      rewardCr:80000, rewardVe:60,
    ...
    // ── Q14-02 장영실 설득 (메인) ──
    {
      ...
      desc:{ko:'장영실 요구 충족: G09 ×3 소비(시뮬레이터 연료) + G25 ×2 소비(거북선 선체 시뮬레이션 재료).\n시뮬레이션 결과: "이 설계... 가능해. 크리그 무기 원석 용골이 핵심이군."',
            en:'G09 ×3 (simulator fuel) + G25 ×2 (hull sim materials). "It works. Krieg ore keel is the key."'},
      objectives:[
        {type:'gather', item:'G09', qty:3, label:{ko:'G09 ×3 시뮬레이터 연료', en:'G09 ×3 sim fuel'}},
        {type:'gather', item:'G25', qty:2, label:{ko:'G25 ×2 시뮬레이션 재료', en:'G25 ×2 sim parts'}},
      ],
    ...
    // ── Q14-03 크리그 정찰대 격퇴 (메인 전투) ──
    {
      ...
      desc:{ko:'가가린: "크리그 정찰함 2기가 기어월드에 접근 중이야. P08 코르넬리우스 사건 때문에 추적해온 것 같아."\n정찰대 격퇴. 장영실: "...고마워. 내 작업실까지 들이닥칠 뻔했어."',
            en:'Defeat 2 Krieg patrol ships pursuing from P08. Jang: "Thanks. They almost reached my shop."'},
      objectives:[
    ...
    // ── Q14-05 기어월드 외곽 잔해 탐색 (서브) ──
    {
      ...
      desc:{ko:'기어월드 폐기 구역 외곽. 메카니카 폐기 부품과 R05 코어가 섞여 있어. 잔해 탐색 3회.\n70% 자원 / 30% 잔해 해적.',
            en:'3× search. R05 cores + Mechanica scrap. 70/30 split.'},
      objectives:[
    ...
    // ── Q14-M 장영실 합류 (영웅 퀘스트) ──
    {
      ...
      objectives:[
        {type:'gather', item:'G10', qty:3, label:{ko:'G10 크리그 무기 원석 ×3', en:'G10 Krieg ore ×3'}},
        {type:'gather', item:'G25', qty:1, label:{ko:'G25 ×1 제작 베이 초기화', en:'G25 ×1 forge init'}},
      ],
      rewardCr:0, rewardVe:0,
      rewardItems:[],
  ...
  P26:[
    // ── Q15-01 P26 저항군 본부 합류 (메인) ──
    {
      ...
      nm:{ko:'P26 저항군 본부 합류', en:'Resistance HQ Arrival'},
      desc:{ko:'P26 최고 사령부 정식 입장. 레인저 브리핑 — 저항군 전체 병력 현황 + 크리그 P14 거점 정보 공유.',
            en:'Official entry. Ranger briefing on full Resistance forces + Krieg P14 base intel.'},
      objectives:[
    ...
    // ── Q15-02 거북선 자원 지원 협상 (메인) ──
    {
      ...
      desc:{ko:'레인저에게 R06 반물질 비축분 협상. 장영실이 거북선 설계 도면 제시.\nG15 ×2 + G28 ×1 소비(협상 성의 표시 — 지구 전통 방식) → 레인저 동의.\n레인저: "저항군 비축 R06 10단 팩. 거북선이 완성되면 우리 기함으로 써주세요."',
            en:'G15 ×2 + G28 ×1 sincerity offering → Ranger agrees. R06 ×10 pack secured.'},
      objectives:[
        {type:'gather', item:'G15', qty:2, label:{ko:'G15 ×2 협상 성의', en:'G15 ×2 sincerity'}},
        {type:'gather', item:'G28', qty:1, label:{ko:'G28 ×1 협상 성의', en:'G28 ×1 sincerity'}},
      ],
    ...
    // ── Q15-03 정식 연대 협약 체결 (메인) ──
    {
      ...
      desc:{ko:'공식 연대 협약 의식. R06 ×5 소비(반물질 에너지로 계약 봉인) → 협약 체결.\n저항군 함선 무상 지원 1기 (F06 중형) + 명성 +80.',
            en:'R06 ×5 (sealed by antimatter) → formal pact. Free F06 mid-class ship + reputation +80.'},
      objectives:[
        {type:'gather', item:'R06', qty:5, label:{ko:'R06 ×5 계약 봉인', en:'R06 ×5 seal'}},
      ],
    ...
    // ── Q15-04 저항군 대형 함선 구매 (서브 함선구매) ──
    {
      ...
      desc:{ko:'마르코: "P26 도크에서 저항군 대형 함선 살 수 있어. HP가 모든 클래스 중 최강이야."\nF06 저항군 대형 함선(1,020,000₡) 구매 → 페이즈 4 크리그 요새 공략 대비.',
            en:'F06 capital ship at 1,020,000₡ — HP top-class for Phase 4 fortress assault.'},
      objectives:[
        {type:'explore', target:'p26_capital_ship', qty:1, label:{ko:'F06 대형 함선 구매', en:'Buy F06 capital'}},
      ],
    ...
    // ── Q15-05 P26 아카이브 탐색 — 설계도 드롭 (서브) ──
    {
      ...
      ic:'📜', npc:'장영실', npcIc:'⚙️', npcKey:'hero02',
      nm:{ko:'P26 아카이브 — 설계도 탐색', en:'P26 Archive — Blueprints'},
      desc:{ko:'저항군 기술 아카이브 전면 탐색. P26은 LGD01 거북선 / H10 레비아탄 / H12 우르사 파쇄기 설계도 드롭 행성.\n탐색 중 각 5% 확률로 설계도 조각 획득.',
            en:'Search P26 archive. 5% each for LGD01 Geobukseon / H10 Leviathan / H12 Ursa Crusher fragments.'},
      objectives:[
    ...
    // ── Q15-M 함선 제작 준비 선언 (이벤트 함선제작 · 페이즈 3 종료) ──
    {
      ...
      desc:{ko:'장영실이 P26 제작 베이에서 거북선 제작 준비 완료 선언.\n거북선(LGD01) 레시피 잠금 해제 → 도크 제작 탭에서 LGD01 제작 가능.\n재료 조건: R06 ×25 / R08 ×15 / R07 ×10 / R04 ×8.',
            en:'LGD01 Geobukseon recipe unlocked at P26 forge bay. Materials: R06×25 / R08×15 / R07×10 / R04×8.'},
      objectives:[
...
const PHASE3_CUTSCENES_KO={
  ...
  // ─── CH05-A "첫 연락" (P22 도착) ───
  p3_ch05a:[
    {char:'hero01', name:'이순신', color:'#c0a060', text:'동쪽 항로 주파수... P22. 저항군 암호 채널이야. 내가 봉인되기 전에 함께했던 전우들의 후예가 그 기지를 운영하고 있어.'},
    ...
    {char:'system', name:'저항군 통신', color:'#88d65b', text:'P22 에코 기지 — 도착 확인. 착지 코드를 제시하라.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'...크리그에서 빼낸 물자를 가져가면 믿어줄 거야.'},
    {char:'commander', name:'{사령관}', color:'#00f3ff', text:'G12 강습 스파이크 있어. 그걸로 충분하다.'}
  ],

  // ─── CH05-B "연대의 뿌리" (Q11-M 완료) ───
  p3_ch05b:[
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'우리 저항군은 지구에서 쫓겨난 사람들이에요. 크리그가 지구 항로를 봉쇄하기 전, 이순신 장군과 함께 싸웠던 선조들의 후손들이죠.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'당신들이 살아있었군.'},
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'크리그가 P23 보급망에 첩자를 심었어요. 우리 내부를 흔들고 있는 거예요.'},
    {char:'hero08', name:'마르코 폴로', color:'#ffd700', text:'P23... 오딧세이 기지. 나도 루트 알아.'},
    {char:'commander', name:'{사령관}', color:'#00f3ff', text:'함께 처리하자.'},
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'연대의 증표를 먼저. 지구 철광석 — 우리 전통 방식이에요.'}
  ],
  ...
  p3_ch05c:[
    ...
    {char:'hero04', name:'가가린', color:'#ffd700', text:'먼저 들어가서 확인해야 해. 조용하게.'},
  ...
  p3_ch06a:[
    ...
    {char:'hero04', name:'가가린', color:'#ffd700', text:'P08 글리제 667Cc. 코르넬리우스 본사가 거기야.'},
    {char:'hero08', name:'마르코 폴로', color:'#ffd700', text:'오그렌이 말한 내부 고발자 — \'닥터 에바\'. P08에 있어. 접촉하면 물증을 줄 수 있다고 했어.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'증거 없이 아우레우스를 적으로 만들면 안 돼. 먼저 확인해야 해.'},
    {char:'baekgu2_advice', name:'백구', color:'#66ddff', text:'P08 항로 입력. 아우레우스 영공 진입 절차 검토 중.'}
  ],

  // ─── CH06-B "광개토의 그림자" (Q13-05 완료) ───
  p3_ch06b:[
    {char:'hero08', name:'마르코 폴로', color:'#ffd700', text:'저 배... 본 적 있어. 은하 경매 시장에서 항상 최고가 써내는 자유 상인이야. 선체에 고구려 기치.'},
    {char:'hero03', name:'광개토대왕', color:'#ff9d52', text:'당신이 {사령관}인가. 크리그와 싸우고 있다고 들었소.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'...광개토. 이름이 낯설지 않군.'},
    {char:'hero03', name:'광개토대왕', color:'#ff9d52', text:'이 행성을 내 손에 넣으면 — 당신과 거래하겠소. 단, P08 경매에서 최고가를 내야 하오.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'저 사람... 경매 자본이 필요하다. 우리가 P08을 낙찰받으면 그가 온다.'},
    {char:'baekgu2_advice', name:'백구', color:'#66ddff', text:'광개토대왕(H03) 합류 조건 등록. P08 경매 낙찰가 약 4,100만 크레딧.'}
  ],

  // ─── CH06-C "설계의 명인" (Q13-H 완료) ───
  p3_ch06c:[
    {char:'hero01', name:'이순신', color:'#c0a060', text:'거북선 — 내가 임진왜란 때 만든 함선이야. 현대 재료로 재현하면 크리그 요새를 정면 돌파할 수 있어.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'설계는 누가 해? 우리 중에 조선공학자 없잖아.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'P11 메카니카 기어월드. 그곳에 장영실이라는 기술자가 있어. 조선 시대 장영실의 기술 DNA를 이어받은 복제 기술자야.'},
  ...
  p3_ch06d:[
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'거북선을 만들겠다고?'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'내 설계도를 갖고 왔어.'},
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'(G10 크리그 무기 원석을 들어 살핀다) 크리그 무기 원석... 이걸로 용골을 만들면 되겠군. 근데 재료가...'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'뭐든 구해 오겠어.'},
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'...중수소 배터리 3개. 내 시뮬레이터 연료야. 가져오면 들어줄게.'}
  ],

  // ─── CH07-A "귀환" (Q14-M 완료) ───
  p3_ch07a:[
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'거북선 완성에 R06 저항군 반물질이 25개 필요해. 지금 우리한테 있는 건...'},
    {char:'hero08', name:'마르코 폴로', color:'#ffd700', text:'최대해봐야 8~10개.'},
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'저항군 본부 P26에 비축이 있을 거야. 레인저한테 받아야 해.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'P26... 그리고 P31. 지구.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'지구. (잠시 침묵) 오래 꿈꿨어.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'{사령관}. 방향은 P26이야. 연대를 공식화하고 R06를 확보하자.'}
  ],

  // ─── CH07-B "본부" (P26 도착) ───
  p3_ch07b:[
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'당신들이 직접 왔군요. 코르넬리우스 사건 — 우리도 들었어요. 아이젠클로가 직접 기술을 구입했다면 생각보다 위협이 심각해요.'},
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'그래서 왔어요. 거북선을 만들 거야. R06 반물질 25개와 저항군 제작 베이 지원이 필요해요.'},
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'...공식 연대 협약을 먼저 체결해야 합니다. 지구의 방식으로.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'(창밖을 보며 조용히) 지구야.'}
  ],

  // ─── CH07-C "전쟁의 시작" (Q15-M 완료 · 페이즈 3 종료) ───
  p3_ch07c:[
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'R06 재료 목록 완성됐어. 거북선 제작 시작 가능해.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'R06 ×25, R08 ×15, R07 ×10, R04 ×8. 모두 확보하면 거북선이 완성된다.'},
    {char:'delivery_F06', name:'레인저 맥시모프', color:'#88d65b', text:'크리그가 P14 행성에 새 거점을 짓고 있어요. 아이젠클로가 직접 지휘 중이에요.'},
    {char:'hero04', name:'가가린', color:'#ffd700', text:'P08 데이터 복호기가 해독한 정보와 일치해. P14가 다음 목표야.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'아이젠클로... 내 전술 데이터로 우리를 막으려 하겠지. 하지만 나는 그의 허점도 알고 있어.'},
    {char:'hero02', name:'장영실', color:'#80e8c0', text:'거북선이 완성되면 아이젠클로의 요새도 뚫린다.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'{사령관}. 페이즈 4 — 행성 16~20. P14 아이젠클로 추적. 거북선 완성.'},
    {char:'baekgu1', name:'백구', color:'#66ddff', text:'페이즈 3 완료. 페이즈 4 — 행성 16~20 · 아이젠클로 추격 · 거북선 완성 · 크리그 요새 돌파.'}
  ]
};
