...
const CRAFT_RECIPES=[
  ...
  {id:'RB09',type:'part',tier:'legend',nm:'흡혈 폭격 코어 ⚡전설',cat:'armor',
   desc:'전설 흡혈 코어. 매 턴 maxHP 12% 회복 + 레이저 발사 시 HP 15%/실드 12% 흡수.',
   mats:[{id:'R06',qty:10},{id:'R02',qty:7},{id:'R05',qty:5}]},
  {id:'RB10',type:'part',tier:'mythic',nm:'영혼 흡수 매트릭스 ✦신화',cat:'armor',
   desc:'신화 흡수 매트릭스. 매 턴 maxHP 18% 회복 + 레이저 발사 시 HP 20%/실드 18% 흡수 + 격침 시 부활.',
