...
const PHASE6_CUTSCENES_KO={
  ...
  p6_ch13b:[
    ...
    {char:'system', name:'우르사 메이저', color:'#ff3366', text:'... 인류의 작은 함대가 마침내 여기까지 왔는가. 100년의 침묵을 깨고.'},
    {char:'system', name:'우르사 메이저', color:'#ff3366', text:'100년 전, 나는 너희 별을 봉인했다. 너희 종족의 침묵은 영원할 줄 알았지. 그러나 — 한 캡슐이 다시 깨어났구나.'},
    {char:'hero01', name:'이순신', color:'#c0a060', text:'그 캡슐 — 나였다. 네가 봉인한 자가 오늘 너의 끝을 가져왔다.'},
    {char:'system', name:'우르사 메이저', color:'#ff3366', text:'이순신. 너의 전술 데이터는 내 방어 알고리즘의 핵심이었다. 너를 봉인한 것은 — 가장 강한 무기를 빼앗기 위함이었다.'},
    {char:'hero06', name:'A. 아인슈타인', color:'#cc99ff', text:'그 알고리즘 — 이순신 장군의 전술이 거꾸로 너의 허점을 가리킨다. 봉인이 풀리면 — 방패가 칼이 되지.'},
    {char:'system', name:'우르사 메이저', color:'#ff3366', text:'아인슈타인까지... 100년 전 균열에 던져버렸던 노학자가 살아있었다니. 흥미롭군.'},
    {char:'system', name:'아이젠클로', color:'#ff6644', text:'우르사 님. 인간들이 거북선이라는 것을 만들었습니다. 거기 — 이순신의 전술 데이터가 적용된 강화 함선입니다.'},
    {char:'system', name:'우르사 메이저', color:'#ff3366', text:'아이젠클로. 너의 임무는 봉쇄였다. 그러나 너는 봉쇄에 실패했다. 변명은 — 받지 않는다.'},
    {char:'commander', name:'{사령관}', color:'#00f3ff', text:'아이젠클로. 100년 동안 인류를 가뒀던 책임 — 오늘 끝낸다.'},
    {char:'system', name:'아이젠클로', color:'#ff6644', text:'(이를 갈며) 인간 따위가... 친위대 알파부터 엡실론까지! 전열 정비! 일점사 — 거북선!'},
